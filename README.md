...
## Links e referências:  
- [RIC, xApps, rApps: A Comprehensive Guide to the Key Players](https://stlpartners.com/articles/network-innovation/ric-xapps-rapps-who-are-the-key-players/)
...
- [Generative AI for Intent-Driven Network Management in 6G RAN: A Case Study on the Mamba Mode](https://arxiv.org/abs/2508.06616)
- [IntAgent: NWDAF-Based Intent LLM Agent
Towards Advanced Next Generation Networks](https://arxiv.org/abs/2601.13114)
- [Towards Intent-based Network Management for the
6G System adopting Multimodal Generative AI](https://ieeexplore.ieee.org/document/10597022)
- [MAESTRO: LLM-Driven Collaborative Automation of
Intent-Based 6G Networks](https://ieeexplore.ieee.org/document/10758700)
- [Mobile-LLaMA: Instruction Fine-Tuning Open-Source LLM for Network Analysis in 5G Networks](https://mcn.cse.psu.edu/paper/other/Mobile-LLaMA.pdf)
